...
A compact, end‑to‑end workflow to clean a used‑vehicles dataset, explore it quickly, build a linear regression model, and export visuals (EDA plots, coefficient bars) plus a one‑pager dashboard and PPT deck.
...
Or open `notebooks/00_quickstart.ipynb` and run cells sequentially.
